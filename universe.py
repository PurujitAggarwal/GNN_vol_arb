"""
Stratified S&P 500 universe for the GNN volatility forecaster.

~74 liquid large-cap stocks, 6-9 per GICS sector.
All selected for: continuous S&P 500 membership, liquid options markets,
and availability of 5-min intraday data.
"""

# Full universe organised by GICS sector
UNIVERSE = {
...
# Stocks we actually generate forecasts for (superset of current trading tickers)
FORECAST_TICKERS = [
    # Original 7 strategy tickers
    "AAPL", "DIS", "MSFT", "PFE", "UNH", "WMT", "XOM",
    # Additional forecast tickers (high liquidity, active options markets)
    "AMZN", "GOOG", "JPM", "GS", "NVDA", "TSLA", "BA",
    "JNJ", "HD", "META",
    # Added tickers with options data
    "AMD", "BAC", "CAT", "GE", "INTC", "MU", "NFLX", "NKE", "SBUX",
]
